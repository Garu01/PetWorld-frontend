...
const AboutUsPage: FunctionComponent = () => {
  ...
  return (
    <div className="about-us-page">
      <Header2
        headerNavigationMargin="0"
        onNavigationLinksContainerClick={onNavigationLinksContainerClick}
        onNavigationLinksContainerClick1={onNavigationLinksContainerClick1}
      />
      <Content />
    </div>
  );
